...
export const snakeBody = [{x: 11, y: 11}]; //Array of objects
let newSegments = 0;
...
export function draw(gameBoard){
    snakeBody.forEach(segment => {
        ...
        snakeElement.style.gridColumnStart = segment.x; //The grid-column-start CSS property specifies a grid item’s start position within the grid column
